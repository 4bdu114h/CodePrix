  ...
  $jsonSchema: {
    ...
    properties: {
      ...
      metrics: {
        bsonType: 'object',
        properties: {
          time: { bsonType: ['double', 'int', 'long'], minimum: 0, maximum: 15000 },
          memory: { bsonType: ['double', 'int', 'long'], minimum: 0, maximum: 1024000 },
        },
      },
      failedTestCase: { bsonType: ['double', 'int', 'long', 'null'], minimum: 0 },
      logs: {
        bsonType: 'object',
        properties: {
